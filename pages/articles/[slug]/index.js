...
function ArticleDetail({ article }) {
    const [isSmallerThan1223] = useMediaQuery("(max-width: 1223px)");
    
    return (
        <Box>
            <NavBar />
            {!isSmallerThan1223 ? <PostSideBar article={article} /> : null}
            {/* <PostSideBar article={article} /> */}
            <Flex justifyContent="center">
                <Box mx={["22", "50", "70"]} maxWidth="680px">
                    <Heading fontSize="46px" as="h1" mb="1" mt="10">
                        {article.title}
                    </Heading>
